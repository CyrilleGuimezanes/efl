...
var pageMod = PageMod({
    include: ["http://www.google.*/*","https://www.google.*/*"], // all urls
    contentScriptFile: [data.url('scripts/jquery-1.11.3.min.js'), data.url('scripts/app.js')],
    contentStyleFile: [data.url('styles/app.css')]
});
