...
#define MyAppSetupName 'ELSConnect'
...
AppCopyright=Copyright © 2015 ELS
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=ELS
AppPublisher=ELS
;AppPublisherURL=http://els.fr
;AppSupportURL=http://...
;AppUpdatesURL=http://...
...
[Registry]
Root: HKLM; Subkey: Software\Google\Chrome\Extensions\edkllfbhgloiiehikaknebollahldokp; ValueType: string; ValueName: Path; ValueData: {pf}\{#MyAppSetupName}\chrome.crx; Flags: uninsdeletekey
Root: HKLM; Subkey: Software\Google\Chrome\Extensions\edkllfbhgloiiehikaknebollahldokp; ValueType: string; ValueName: Version; ValueData: {#MyAppVersion}; Flags: uninsdeletekey
Root: HKLM; Subkey: Software\Mozilla\Firefox\Extensions; ValueType: string; ValueName: ELSConnect@els.fr; ValueData: {pf}\{#MyAppSetupName}\firefox.xpi; Flags: uninsdeletekey
...
[Files]
Source: ..\..\bin\firefox.xpi; DestDir: {pf}\{#MyAppSetupName}\firefox.xpi; Flags: ignoreversion
Source: ..\..\bin\chrome.crx; DestDir: {pf}\{#MyAppSetupName}\chrome.crx; Flags: ignoreversion
Source: ..\..\src\core\images\icon.ico; DestDir: {app}; DestName: icon.ico; Flags: noencryption nocompression

[Dirs]
Name: {pf}\{#MyAppSetupName}
Name: {reg:HKLM\Software\Google\Chrome\Extensions,Path|{pf}\{#MyAppSetupName}}
Name: {reg:HKLM\Software\Mozilla\Firefox\Extensions,Path|{pf}\{#MyAppSetupName}}


[Icons]
Name: {group}\{#MyAppSetupName}; Filename: {app}\icon.ico
Name: {group}\{cm:UninstallProgram,{#MyAppSetupName}}; Filename: {app}\icon.ico
Name: {commondesktop}\{#MyAppSetupName}; Filename: {app}\icon.ico; Tasks: desktopicon
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppSetupName}; Filename: {app}\icon.ico; Tasks: quicklaunchicon
